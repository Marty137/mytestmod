...
public class NuggetWasher extends BlockContainer
{
    /**
    ...
    public boolean onBlockActivated(World World, int x, int y, int z, EntityPlayer Player, int i, float f, float g, float t)
    {
        		...
        		Player.openGui(MyTestMod.instance, 0, World, x, y, z);
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, MyTestMod.nuggetWasherWorking.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, MyTestMod.nuggetWasherIdle.blockID);
        }
    ...
    {
        return new TileEntityNuggetWasher();
    }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityNuggetWasher)par1World.getBlockTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
        	TileEntityNuggetWasher tileentityfurnace = (TileEntityNuggetWasher)par1World.getBlockTileEntity(par2, par3, par4);
